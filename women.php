...
$site_title = "WOMEN'S COLLECTION | FashionStore";
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body class="font-sans">
    ...
    <main class="pt-32 pb-20 px-6">
        <div class="container mx-auto max-w-7xl">
            ...
            <div class="mb-16">
                <span class="text-gold text-xs uppercase tracking-[0.6em] font-black">Archive 02</span>
                <h1 class="font-serif text-6xl text-white italic">Women's <span class="text-gold">Atelier</span></h1>
            </div>
