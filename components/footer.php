<footer class="bg-black text-white pt-10 pb-8 overflow-hidden relative">
    ...
    <div class="container mx-auto px-6 relative z-10">
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 mb-8">
            ...
            <div class="lg:col-span-5 space-y-4">
                <div class="space-y-2">
                    <h3 class="font-serif text-2xl md:text-3xl tracking-tight">FASHION<span
                ...
                <div class="flex space-x-4">
                    <a href="#"
                        class="w-10 h-10 rounded-full glass border border-white/10 flex items-center justify-center transition-all duration-500 hover:bg-gold hover:border-gold group">
                    ...
                    <a href="#"
                        class="w-10 h-10 rounded-full glass border border-white/10 flex items-center justify-center transition-all duration-500 hover:bg-gold hover:border-gold group">
                        <i class="fab fa-pinterest-p text-xs group-hover:scale-110 transition-transform"></i>
                    </a>
                    <a href="#"
                        class="w-10 h-10 rounded-full glass border border-white/10 flex items-center justify-center transition-all duration-500 hover:bg-gold hover:border-gold group">
                        <i class="fab fa-x-twitter text-xs group-hover:scale-110 transition-transform"></i>
                    </a>
                </div>
            </div>
            ...
            <div class="lg:col-span-7 grid grid-cols-1 sm:grid-cols-3 gap-8">
                ...
                <div class="space-y-4">
                    ...
                    <ul class="space-y-2">
                        <li><a href="<?php echo $base_url; ?>components/product.php?category=Men"
                                class="text-gray-400 hover:text-white text-xs font-light transition-all hover:translate-x-2 inline-block">New
                                Arrivals</a></li>
                        <li><a href="<?php echo $base_url; ?>components/product.php?category=Women"
                                class="text-gray-400 hover:text-white text-xs font-light transition-all hover:translate-x-2 inline-block">Womenswear</a>
                        </li>
                        <li><a href="<?php echo $base_url; ?>components/product.php?category=Men"
                                class="text-gray-400 hover:text-white text-xs font-light transition-all hover:translate-x-2 inline-block">Menswear</a>
                        </li>
                        <li><a href="<?php echo $base_url; ?>components/product.php?category=Accessories"
                                class="text-gray-400 hover:text-white text-xs font-light transition-all hover:translate-x-2 inline-block">Accessories</a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="space-y-4">
                    ...
                    <ul class="space-y-2">
                        <li><a href="#"
                                class="text-gray-400 hover:text-white text-xs font-light transition-all hover:translate-x-2 inline-block">Shipping
                                & Logistics</a></li>
                        <li><a href="#"
                                class="text-gray-400 hover:text-white text-xs font-light transition-all hover:translate-x-2 inline-block">Private
                                Appointments</a></li>
                        <li><a href="#"
                                class="text-gray-400 hover:text-white text-xs font-light transition-all hover:translate-x-2 inline-block">Returns
                                Policy</a></li>
                        <li><a href="#"
                                class="text-gray-400 hover:text-white text-xs font-light transition-all hover:translate-x-2 inline-block">Size
                                Consultation</a></li>
                    </ul>
                </div>
                ...
                <div class="space-y-4">
                    ...
                    <ul class="space-y-2">
                        <li><a href="<?php echo $base_url; ?>components/contact.php"
                                class="text-gray-400 hover:text-white text-xs font-light transition-all hover:translate-x-2 inline-block">Contact
                                Us</a></li>
                        <li><a href="<?php echo $base_url; ?>components/about.php"
                                class="text-gray-400 hover:text-white text-xs font-light transition-all hover:translate-x-2 inline-block">Our
                                Story</a></li>
                        <li><a href="#"
                                class="text-gray-400 hover:text-white text-xs font-light transition-all hover:translate-x-2 inline-block">Privacy
                                Protocol</a></li>
                        <li><a href="#"
                                class="text-gray-400 hover:text-white text-xs font-light transition-all hover:translate-x-2 inline-block">Terms
                                of Service</a></li>
                    </ul>
                </div>
            </div>
        ...
        <div class="pt-6 border-t border-white/5 flex flex-col items-center gap-4">
            ...
            <div
                class="flex items-center space-x-6 opacity-20 grayscale hover:grayscale-0 hover:opacity-100 transition-all duration-700">
