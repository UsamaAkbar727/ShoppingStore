        ...
        <div class="container mx-auto max-w-7xl">
            ...
            <div class="flex flex-col md:flex-row justify-between items-end mb-20 gap-8 animate-fade-up">
                <div class="space-y-4">
                    ...
                    <h1 class="font-serif text-5xl md:text-7xl text-white italic">Contact the <span
                            class="text-gold">Atelier</span></h1>
                </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                ...
                <div class="space-y-8 animate-fade-up" style="animation-delay: 0.2s;">
                    <div class="glass rounded-3xl p-10 md:p-12 space-y-10">
                        <div class="flex items-start gap-8 group">
                            <div
                                class="w-14 h-14 bg-gold/10 rounded-2xl flex items-center justify-center text-gold group-hover:bg-gold group-hover:text-white transition-all duration-500">
                                <i class="fas fa-map-marker-alt text-xl"></i>
                            </div>
                            <div>
                                <h3 class="font-serif text-xl text-white mb-2">Grand Atelier</h3>
                                <p class="text-gray-400 text-sm font-light">123 Boulevard of Excellence, Suite
                                    500<br>Lahore, Pakistan</p>
                            </div>
                        </div>
                    ...
                    <div class="glass rounded-3xl overflow-hidden p-4 group">
                        <div
                            class="rounded-2xl overflow-hidden grayscale contrast-125 opacity-70 group-hover:grayscale-0 group-hover:opacity-100 transition-all duration-1000">
                            <iframe
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3403.828535472855!2d73.0941809743002!3d31.44638705079584!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3922696ac9459bed%3A0x4d837d0ef403530e!2sCareer%20Institute%20-%20Millat%20Chowk%20Branch%20Faisalabad!5e0!3m2!1sen!2s!4v1755324965190!5m2!1sen!2s"
                ...
                <div class="glass rounded-3xl p-10 md:p-12 animate-fade-up" style="animation-delay: 0.4s;">
                    <div class="mb-10">
                        <h2 class="font-serif text-3xl text-white mb-4 italic">Send a <span
                                class="text-gold">Message</span></h2>
                    ...
                    <form action="" method="POST" class="space-y-8">
                        <div class="space-y-4">
                            <label for="name"
                                class="text-[10px] uppercase tracking-[0.4em] text-gray-500 font-black">Your
                                Name</label>
                        ...
                        <div class="space-y-4">
                            <label for="email"
                                class="text-[10px] uppercase tracking-[0.4em] text-gray-500 font-black">Electronic
                                Mail</label>
                        ...
                        <div class="space-y-4">
                            <label for="message"
                                class="text-[10px] uppercase tracking-[0.4em] text-gray-500 font-black">Inquiry
                                Details</label>
